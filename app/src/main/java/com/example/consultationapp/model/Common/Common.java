package com.example.consultationapp.model.Common;
...
public class Common {
    ...
    public static String currentLecturer = "testdoc@testdoc.com";
    public static String Currentaappointementatype;
    public static int currentTimeSlot = -1;
    public static String currentLecturerName = "yassine";
