...
public class BookingStep2Fragment extends Fragment implements ITimeSlotLoadListener {
    ...
    private void loadAvailabelTimeSlotOfDoctor(String doctorId, final String bookDate) {
        dialog.show();
        System.out.println("This is the doctorId "+doctorId);
        //firebaseAuth = FirebaseAuth.getInstance();
        //fStore = FirebaseFirestore.getInstance();

        //FirebaseUser user = firebaseAuth.getCurrentUser();
        //doctorDoc = fStore.collection("Lecturer").document(doctorId);
        //System.out.println("This me the logedin User " + user.getEmail());
                ...
                if(task.isSuccessful())
                {
                    ...
                    if(documentSnapshot.exists()){
                        CollectionReference date =FirebaseFirestore.getInstance()
                                .collection("Lecturer")
                                .document(Common.currentLecturer)//doctorId
                                .collection(bookDate);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        init(itemView);
        loadAvailabelTimeSlotOfDoctor(Common.currentLecturer,simpleDateFormat.format(Common.currentDate.getTime()));
