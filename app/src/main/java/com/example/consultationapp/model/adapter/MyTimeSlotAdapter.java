...
import com.example.consultationapp.TimeSlot;
import com.example.consultationapp.model.Interface.IRecyclerItemSelectedListener;
                    ...
                    documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            ...
                            if(documentSnapshot.exists()){
                                System.out.println("Document exists "+documentSnapshot.getString("Role"));
                                role = ""+documentSnapshot.getString("Role");
                                if(role.equals(Role.Lecturer) && holder.txt_time_slot_description.getText().equals("Available")){
                                    ...
                                    alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            apointementInformation.setLecturerId(Common.currentLecturer);
                                            apointementInformation.setLecturerName(Common.currentLecturerName);
                                            apointementInformation.setChemin("Lecturer/"+Common.currentLecturer +"/"+Common.simpleFormat.format(Common.currentDate.getTime())+"/"+String.valueOf(Common.currentTimeSlot));
                                            ...
                                            DocumentReference bookingDate = FirebaseFirestore.getInstance()
                                                    .collection("Lecturer")
                                                    .document(Common.currentLecturer)
