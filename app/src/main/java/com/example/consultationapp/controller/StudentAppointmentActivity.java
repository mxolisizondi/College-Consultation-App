...
import com.example.consultationapp.model.adapter.StudentAppointmentsAdapter;
...
public class StudentAppointmentActivity extends AppCompatActivity {
    ...
    private StudentAppointmentsAdapter adapter;
    @Override
    ...
    public void setUpRecyclerView(){
        ...
        adapter = new StudentAppointmentsAdapter(options);
        //List current appointments
        RecyclerView recyclerView = findViewById(R.id.student_appointements);
