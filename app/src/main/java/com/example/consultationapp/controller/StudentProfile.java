    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveChanges.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                checkField(phone);
                if(!valid){
                    Toast.makeText(StudentProfile.this, "One or Many fields are empty.", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
        ...
        fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Picasso.get().load(uri).into(profileImageView);
                        Toast.makeText(StudentProfile.this, "Profile successful changed.", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(StudentProfile.this, "Failed to upload image.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
