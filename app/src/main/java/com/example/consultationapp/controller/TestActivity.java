...
import com.example.consultationapp.model.Common.NonSwipeViewPager;
import com.example.consultationapp.model.adapter.MyViewPagerAdapter;
...
import static com.example.consultationapp.model.Common.Common.step;
import static com.example.consultationapp.model.fragment.BookingStep1Fragment.spinner;
...
public class TestActivity extends AppCompatActivity {
        ...
        btn_next_step.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(step < 3 || step == 0 ){
                    ...
                    if(step==1){
                        if(Common.currentLecturer != null) {
                            Common.currentTimeSlot = -1;
                            Common.currentDate = Calendar.getInstance();
                            loadTimeSlotOfDoctor(Common.currentLecturer);
                        }
                    }
                    else if(step == 2){
    ...
    private void setColorButton() {
        System.out.println("setColorButton was called");
    ...
    private void setupStepView() {
        System.out.println("Setup step view");
